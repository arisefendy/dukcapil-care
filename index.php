    ...
    if ($data) {
        if (password_verify($password, $data['password'])) {
            ...
            echo "<script>
                    ...
                    location.href='modules/penduduk/index.php'
                </script>";
        } else {
            echo "<script>
...
<body>
    <form action="" method="POST" class="form-signin">
        ...
        <p class="text-center mt-2">Belum memiliki akun? <span><a href="modules/penduduk/register.php" class="text-decoration-none fw-semibold">Daftar sekarang</a></span></p>
